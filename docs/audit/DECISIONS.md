...
| D4 | 2026-09-19 | **Canonical host = `https://sjabrankamran.com` (non-www).** Rationale: every brand surface, portal link, QR handout, WhatsApp/KB reference uses non-www; www must 308 → non-www. Implemented on branch (see backlog B1) pending JB merge approval. | Pablo → JB to ratify | Proposed |
